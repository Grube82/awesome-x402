...
### Data & Social APIs
- [Biotech Catalyst Sentinel](https://biotechcatalystsentinel.com) — Upcoming FDA PDUFA decision dates for US-listed biotechs, extracted from primary SEC 8-K/6-K filings (classify-before-extract, source-quote-grounded). Date accuracy is backtested against actual FDA decisions (median 1-day error) and independently verifiable — check the free `/v1/accuracy` proof before paying. $0.02/call, USDC on Base or Solana. ([API](https://api.biotechcatalystsentinel.com) | [Discovery](https://api.biotechcatalystsentinel.com/.well-known/x402) | [Free accuracy proof](https://api.biotechcatalystsentinel.com/v1/accuracy))
