...
- **[Crypto ETF Sentinel](https://cryptoetfsentinel.com)** — US spot crypto ETF regulatory intelligence oracle. Curates 3,100+ SEC filings across 105 issuers and 36 cryptocurrencies, with approval-pipeline tracking, XBRL financials, POS AM operational data (sponsor fees, custodian, AP rosters), and fee-war monitoring. 22 routes priced $0.05–$1.00 USDC on Base + Solana mainnet via CDP facilitator. [Docs](https://api.cryptoetfsentinel.com/docs)
